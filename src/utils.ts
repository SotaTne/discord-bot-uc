...
// 挙手受付可能な時間帯（24時間制）
export const startOclocks = new Set([/*14, 15,*/ 17, 21, 22, 23]); // デフォルトは[ 21, 22, 23]
export const startRecruitment = 16; // デフォルトは12
...
export const startBeforeLimitMinutes = 20; //デフォルトは7
